...
const POSTS = [
  {
    date: "Oct 30, 2025",
    title: "Building Prometheus: A Post-Mortem",
    excerpt: "Six months of 6DOF video matting, RL feedback loops, and GPU orchestration. What broke, what worked, what's next.",
