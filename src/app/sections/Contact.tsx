      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="lg:w-5/12 flex flex-col">
          ...
          <div className="contact-animate flex flex-wrap gap-6 text-[var(--text-tertiary)] items-center">
            ...
            <a 
              href="https://calendly.com/josh-prometheus/prometheus-discovery-call"
              target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center w-6 h-6 hover:text-[var(--text-primary)] hover:scale-110 transition-all duration-300" aria-label="Book a discovery call on Calendly"
            >
