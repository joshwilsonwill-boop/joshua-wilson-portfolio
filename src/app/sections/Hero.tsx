          ...
          <div className="h-[2.5rem] flex items-center mb-6">
            <Typewriter 
              phrases={[
                ...
                "Building systems with a pulse.",
                "Precision is the baseline.",
                "No templates. Just intent.",
                "Founders turn ambiguity into motion.",
                "Build what you wish existed.",
                "Craft with a point of view.",
                "Good ideas deserve good craft.",
                "The details do the talking.",
                "Make complexity feel calm.",
                "Build for the decade, not the demo.",
                "Clarity compounds.",
                "Good taste is strategic.",
                "Useful things earn their place.",
                "I shape ideas with clarity.",
                "Make the hard decision early.",
                "Every detail earns its place.",
                "Where craft meets consequence.",
                "Clarity before complexity.",
                "Hard problems. Beautiful outcomes.",
                "Less noise. More intention.",
                "Ship the lesson, not the feature.",
                "Thoughtful by default.",
                "A strong idea, well made.",
                "Ambition with a human touch.",
                "Built with nerve and nuance.",
                "Good work feels inevitable.",
                "From thought to shipped.",
                "The hard parts, made simple.",
                "Make it useful. Make it memorable.",
                "Make the complex feel inevitable.",
                "The first version teaches you.",
                "Ship early. Refine relentlessly.",
                "A calm system beats a clever one.",
                "Build once. Learn forever.",
                "Ownership sharpens the work.",
                "Keep the signal. Cut the noise.",
                "Long games reward clear thinking.",
                "Taste is knowing what to leave out.",
                "Attention is a design decision.",
                "Build for users, not applause.",
                "Make useful things unforgettable."
              ]}
              className="whitespace-nowrap font-bold text-[clamp(1rem,2.5vw,1.5rem)] text-[#a1a1a6]"
            />
          </div>
